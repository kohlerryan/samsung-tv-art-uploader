...
> **Upgrading from v0.2.x?** See the [v0.2.1-beta.1 release notes](https://github.com/kohlerryan/samsung-tv-art-card/releases/tag/v0.2.1-beta.1) for what's new.
...
2. Register the resource in `configuration.yaml`:
   ...
   lovelace:
     resources:
       - url: /local/samsung-tv-art-card/samsung-tv-art-card.js?v=v0.2.1-beta.1
         type: module
   ```
...
Current version: **v0.2.1-beta.1** — bump the `?v=` cache-buster in the resource URL whenever you upgrade.
